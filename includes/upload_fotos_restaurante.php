 ...
 * para o restaurante indicado, gravando cada uma na tabela restaurante_foto.
 *
...
function salvarFotosRestaurante($id_restaurante, $campo = 'fotos')
{
    ...
    for ($i = 0; $i < $totalFotos; $i++) {
        ...
        $nomeArquivo = uniqid('restaurante_', true) . '.' . $extensao;
        ...
        $restauranteFoto->adicionar($id_restaurante, $nomeArquivo);
    }
